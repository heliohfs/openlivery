...
(
    ...
    customer_id bigint not null constraint order_customer_user_fkey references "user" on delete set null,
    ...
    delivery_address_id bigint not null constraint order_delivery_address_fkey references address on delete set null,
