...
(
    customer_id bigint not null constraint customer_coupon_customer_fkey references customer(user_id),
    ...
    constraint customer_coupon_pkey primary key(customer_id, coupon_code)
);
